...
verification/                # اسکرین‌شات‌های تاییدیه و تست‌های Playwright
```
...
- **تست رابط کاربری (UI Testing):** با استفاده از Playwright، اسکرین‌شات‌هایی از تمامی بخش‌های برنامه تهیه شده که در پوشه `verification/` موجود است.
